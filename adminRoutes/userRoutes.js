...
const { register, login, getAllEnterprenuers, getAllInvestors, getAppointments, deleteAppointmentById, createUser, deleteEIById, getWebinarBooking, deleteWebinarBookingById} = require('../adminControllers/userController');
